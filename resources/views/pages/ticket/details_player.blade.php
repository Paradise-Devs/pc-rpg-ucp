...
<header id="topbar" class="alt affix">
    ...
    <div class="topbar-right">
        ...
        <a href="ticket_manage.html" type="button" class="closed_ticket btn btn-sm btn-danger btn-gradient dark">
            <i class="fa fa-unlock-alt"></i> Reabrir Ticket
        </a>
        <a href="ticket_manage.html" type="button" class="opened_ticket btn btn-sm btn-danger btn-gradient dark">
