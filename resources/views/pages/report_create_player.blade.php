...
<header id="topbar" class="alt affix">
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="crumb-trail">Denúnciar: Jogador</li>
        </ol>
    </div>
</header>
@endsection
            ...
            <div class="panel panel-primary heading-border">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="title" class="field prepend-icon">
                                    <input type="text" name="title" id="title" class="gui-input" placeholder="Acusado (Nome_Sobrenome)" required>
                ...
                <div class="panel-footer">
                    <div class="btn-group">
                        ...
                        <a href="complaint_index.html" type="submit" class="btn btn-default btn-gradient dark btn-blocks">
