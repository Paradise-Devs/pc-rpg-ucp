    ...
    <header id="topbar" class="affix">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-trail">Editar blueprint</li>
            </ol>
        </div>
    </header>
@endsection
...
@section('content')
    <section id="content" class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ url('/blueprints/' . $blueprint->id) }}" method="post" id="post_form">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="admin-form theme-primary">
                        <div class="panel panel-primary panel-border top">
                            <div class="panel-heading">
                                <span class="panel-title"><i class="fa fa-file-text"></i>Editar blueprint</span>
                            ...
                            <textarea id="markdown-editor" name="description" data-language="pt" rows="10" placeholder="Diga-nos, detalhadamente, qual o problema que está enfrentando?">{{ $blueprint->description }}</textarea>
                                ...
                                <div class="section row">
                                    <div class="col-md-12">
                                        <label for="title" class="field {{ $errors->has('title') ? 'state-error' : '' }}">
                                            <input type="text" name="title" id="title" class="gui-input" maxlength="70" placeholder="Título" value="{{ $blueprint->title }}" required>
                                        </label>
                                        @if ($errors->has('title'))
                            ...
                            <div class="panel-footer text-right">
                                <div class="btn-group">
                                    <a href="{{ url('/blueprints') }}" class="btn btn-default btn-gradient dark btn-blocks">
