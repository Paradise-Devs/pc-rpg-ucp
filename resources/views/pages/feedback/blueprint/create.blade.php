    ...
    <header id="topbar" class="affix">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-trail">Sugerir blueprint</li>
            </ol>
        </div>
    </header>
@endsection
...
@section('content')
    <section id="content" class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ url('/blueprints') }}" method="post" id="post_form">
                    {{ csrf_field() }}
                    <div class="admin-form theme-primary">
                        <div class="panel panel-primary panel-border top">
                            <div class="panel-heading">
                                <span class="panel-title"><i class="fa fa-file-text"></i>Sugerir blueprint</span>
