                ...
                <div class="message-view">
                    ...
                    <div class="message-meta">
                        <span class="pull-right">
                            <span class="label label-{{ $bug->status_style }} fs15"><i class="fa fa-{{ $bug->status_icon }}"></i> {{ $bug->status }}</span>
                            <span class="label label-{{ $bug->importance_style }} fs15"><i class="fa fa-{{ $bug->importance_icon }}"></i> {{ $bug->importance }}</span>
                        </span>
                    ...
                    <div class="message-header">
                        ...
                        <div class="pull-right mt5 clearfix">
                            ...
                            @elseif($user->id != $bug->user->id && $bug->status != 'corrigido')
                                ...
                                <button type="submit" form="form_affects" class="btn btn-sm btn-gradient btn-success {{ ($affected) ? 'active' : '' }}"><i class="fa fa-thumbs-up"></i> este bug afetou {{ ($affected) ? 'você e outra(s) ' : '' }}{{ ($affected) ? $affects : ($affects + 1) }} pessoa(s)</button>
                            @endif
                        </div>
                        <h4>
