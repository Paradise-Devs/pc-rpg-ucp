        ...
        <ul class="nav sub-nav">
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
                <a href="pages_login(alt).html" target="_blank"> Login Alt </a>
              </li>
              <li>
                <a href="pages_register.html" target="_blank"> Register </a>
              </li>
              <li>
                <a href="pages_register(alt).html" target="_blank"> Register Alt </a>
              </li>
              <li>
                <a href="pages_screenlock.html" target="_blank"> Screenlock </a>
              </li>
              <li>
                <a href="pages_screenlock(alt).html" target="_blank"> Screenlock Alt </a>
              </li>
              <li>
                <a href="pages_forgotpw.html" target="_blank"> Forgot Password </a>
              </li>
              <li>
                <a href="pages_forgotpw(alt).html" target="_blank"> Forgot Pass Alt </a>
              </li>
              <li>
                <a href="pages_confirmation.html" target="_blank"> Confirmation </a>
              </li>
              <li>
