        ...
        <div class="row">
          <div class="col-sm-7 pr30">
            ...
            <div class="section">
              ...
              <label for="email" class="field prepend-icon {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="section">
              ...
              <label for="password" class="field prepend-icon {{ $errors->has('password') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-5 br-l br-grey pl30">
            ...
            <p class="mb15">
              <span class="fa fa-check text-success pr5"></span> Totalmente gratuido</p>
            <p class="mb15">
              <span class="fa fa-check text-success pr5"></span> Ilimitadas possibilidades</p>
            <p class="mb15">
              <span class="fa fa-check text-success pr5"></span> Conquiste propriedades</p>
            <p class="mb15">
              <span class="fa fa-check text-success pr5"></span> Conheça pessoas novas</p>
          </div>
        </div>
      </div>
